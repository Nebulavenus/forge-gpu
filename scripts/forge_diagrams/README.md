...
python scripts/forge_diagrams --all               # regenerate all 246 diagrams
...
├── gpu/               GPU lesson diagrams (24 lessons, 108 diagrams)
...
└── assets/            Asset pipeline lesson diagrams (3 lessons, 8 diagrams)
```
