...
DIAGRAMS = {
    ...
    "physics/03": [
        ("sphere_sphere_collision.png", diagram_sphere_sphere_collision),
        ("impulse_response.png", diagram_impulse_response),
        ("restitution_comparison.png", diagram_restitution_comparison),
        ("collision_pipeline.png", diagram_collision_pipeline),
        ("momentum_conservation.png", diagram_momentum_conservation),
    ],
    "physics/04": [
        ("rigid_body_state.png", diagram_rigid_body_state),
        ("inertia_tensor.png", diagram_inertia_tensor),
        ("inertia_shapes.png", diagram_inertia_shapes),
        ("quaternion_rotation.png", diagram_quaternion_rotation),
        ("angular_velocity.png", diagram_angular_velocity),
        ("torque_force_at_point.png", diagram_torque_force_at_point),
        ("world_space_inertia.png", diagram_world_space_inertia),
        ("integration_flowchart.png", diagram_integration_flowchart),
        ("precession.png", diagram_precession),
        ("kinetic_energy.png", diagram_kinetic_energy),
    ],
    "gpu/03": [
    ...
    "gpu/37": [
        ("color_id_picking.png", diagram_color_id_picking),
        ("stencil_id_picking.png", diagram_stencil_id_picking),
        ("gpu_readback_pipeline.png", diagram_gpu_readback_pipeline),
        ("picking_method_comparison.png", diagram_picking_method_comparison),
        ("outline_selection.png", diagram_outline_selection),
        ("pick_event_timing.png", diagram_pick_event_timing),
        ("id_color_encoding.png", diagram_id_color_encoding),
    ],
    "gpu/38": [
        ("indirect_draw_concept.png", diagram_indirect_draw_concept),
        ("frustum_culling_diagram.png", diagram_frustum_culling),
        ("indirect_buffer_layout.png", diagram_indirect_buffer_layout),
        ("compute_to_render_pipeline.png", diagram_compute_to_render_pipeline),
        ("split_screen_layout.png", diagram_split_screen_layout),
        ("sphere_frustum_test.png", diagram_sphere_frustum_test),
    ],
    "gpu/39": [
        ("asset_pipeline_flow.png", diagram_asset_pipeline_flow),
        ("bc7_block_compression.png", diagram_bc7_block_compression),
        ("bc5_normal_z_reconstruction.png", diagram_bc5_normal_z_reconstruction),
        ("fmesh_binary_layout.png", diagram_fmesh_binary_layout),
        ("lod_distance_selection.png", diagram_lod_distance_selection),
        ("tbn_gram_schmidt.png", diagram_tbn_gram_schmidt),
    ],
    "ui/01": [
...
LESSON_NAMES = {
    ...
    "physics/03": "physics/03-particle-collisions",
