...
DIAGRAMS = {
    ...
    "assets/19": [
        ("lesson_19_fmesh_layout.png", diagram_fmesh_browser_layout),
        ("lesson_19_loading_pipeline.png", diagram_loading_pipeline),
        ("lesson_19_lod_switching.png", diagram_lod_switching),
    ],
    "engine/04": [
    ...
    "engine/13": [
        ("fat_pointer_layout.png", diagram_fat_pointer_layout),
        ("growth_policy.png", diagram_growth_policy),
        ("hash_map_dual_structure.png", diagram_hash_map_dual_structure),
        ("bucket_probing.png", diagram_bucket_probing),
        ("string_map_arena.png", diagram_string_map_arena),
    ],
    "math/01": [
    ...
    "math/17": [
        ("sdf_distance_field.png", diagram_sdf_distance_field),
        ("csg_operations.png", diagram_csg_operations),
        ("smooth_blend.png", diagram_smooth_blend),
        ("gradient_field.png", diagram_gradient_field),
        ("marching_squares.png", diagram_marching_squares),
    ],
    "math/18": [
        ("gradient_quiver.png", diagram_gradient_quiver),
        ("heightmap_normals.png", diagram_heightmap_normals),
        ("gradient_descent_path.png", diagram_gradient_descent_path),
        ("laplacian_classification.png", diagram_laplacian_classification),
    ],
    "physics/01": [
    ...
    "physics/05": [
        ("force_at_point.png", diagram_force_at_point),
        ("force_accumulator_lifecycle.png", diagram_force_accumulator_lifecycle),
        ("drag_terminal_velocity.png", diagram_drag_terminal_velocity),
        ("gyroscopic_stability.png", diagram_gyroscopic_stability),
        ("friction_decomposition.png", diagram_friction_decomposition),
    ],
    "physics/06": [
        ("coulomb_friction_cone.png", diagram_coulomb_friction_cone),
        ("contact_normal_tangent.png", diagram_contact_normal_tangent),
    ...
    "physics/11": [
        ("clipping_pipeline.png", diagram_clipping_pipeline),
        ("reference_incident_faces.png", diagram_reference_incident_faces),
    ...
    "physics/13": [
        ("ball_socket_joint.png", diagram_ball_socket_joint),
        ("hinge_joint.png", diagram_hinge_joint),
        ("slider_joint.png", diagram_slider_joint),
    ...
    "physics/15": [
        ("simulation_pipeline.png", diagram_simulation_pipeline),
        ("island_detection.png", diagram_island_detection),
        ("sleep_evaluation.png", diagram_sleep_evaluation),
    ],
    "gpu/03": [
    ...
    "gpu/46": [
        ("particle_lifecycle.png", diagram_particle_lifecycle),
...
LESSON_NAMES = {
    ...
    "assets/19": "assets/19-pipeline-asset-viewer",
    ...
    "engine/13": "engine/13-stretchy-containers",
    ...
    "math/17": "math/17-implicit-curves",
    "math/18": "math/18-scalar-field-gradients",
    ...
    "physics/15": "physics/15-simulation-loop",
