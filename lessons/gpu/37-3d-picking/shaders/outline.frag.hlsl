 ...
 *
 * Used with the outline pipeline to render a scaled-up version of a selected
 * object in a solid color.  The stencil test (configured in pipeline state)
 * rejects fragments where the original object was drawn, leaving only the
 * outline visible around the silhouette.
 *
