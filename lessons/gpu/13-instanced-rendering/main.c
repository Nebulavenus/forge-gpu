...
#include "shaders/compiled/instanced_vert_msl.h"
#include "shaders/compiled/instanced_frag_dxil.h"
#include "shaders/compiled/instanced_frag_msl.h"
...
SDL_AppResult SDL_AppInit(void **appstate, int argc, char *argv[])
{
    ...
    SDL_GPUShader *inst_vs = create_shader(
        ...
        instanced_vert_msl,   instanced_vert_msl_size,
    ...
    SDL_GPUShader *inst_fs = create_shader(
        ...
        instanced_frag_msl,   instanced_frag_msl_size,
