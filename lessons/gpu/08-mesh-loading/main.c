...
#include "shaders/compiled/mesh_vert_msl.h"
#include "shaders/compiled/mesh_frag_dxil.h"
#include "shaders/compiled/mesh_frag_msl.h"
...
/* ── Shader helper ───────────────────────────────────────────────────────── */
/* Same as Lesson 07 — creates a shader from SPIRV, DXIL, or MSL shader code. */
...
SDL_AppResult SDL_AppInit(void **appstate, int argc, char *argv[])
{
    ...
    SDL_GPUShader *vertex_shader = create_shader(
        ...
        mesh_vert_msl,   mesh_vert_msl_size,
        VERT_NUM_SAMPLERS,
    ...
    SDL_GPUShader *fragment_shader = create_shader(
        ...
        mesh_frag_msl,   mesh_frag_msl_size,
        FRAG_NUM_SAMPLERS,
