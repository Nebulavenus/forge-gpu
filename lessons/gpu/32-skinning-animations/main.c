    ...
    *appstate = state;
    ...
    /* ── Skinned pipeline ───────────────────────────────────────── */
    {
        ...
        SDL_GPUShader *vert = create_shader(
            ...
            skin_vert_msl,   skin_vert_msl_size,
            0, 2);
        ...
        SDL_GPUShader *frag = create_shader(
            ...
            skin_frag_msl,   skin_frag_msl_size,
            2, 1);
        if (!vert || !frag) {
    ...
    /* ── Shadow pipeline (skinned) ──────────────────────────────── */
    {
        ...
        SDL_GPUShader *vert = create_shader(
            ...
            shadow_skin_vert_msl,   shadow_skin_vert_msl_size,
            0, 2);
        SDL_GPUShader *frag = create_shader(
            device, SDL_GPU_SHADERSTAGE_FRAGMENT,
