...
| [<img src="07-camera-and-input/assets/screenshot.png" width="480" alt="Camera & Input"/>](07-camera-and-input/) | [**07 — Camera & Input**](07-camera-and-input/) | First-person fly camera with quaternion orientation, keyboard/mouse input, and delta time |
| [<img src="08-mesh-loading/assets/screenshot.png" width="480" alt="Mesh Loading"/>](08-mesh-loading/) | [**08 — Mesh Loading**](08-mesh-loading/) | Load a 3D model from an OBJ file with file-based textures and mipmaps |
| [<img src="09-scene-loading/assets/screenshot.png" width="480" alt="Scene Loading"/>](09-scene-loading/) | [**09 — Scene Loading**](09-scene-loading/) | Load glTF 2.0 scenes with multi-material meshes, scene hierarchy, and indexed drawing |
| [<img src="10-basic-lighting/assets/screenshot.png" width="480" alt="Basic Lighting"/>](10-basic-lighting/) | [**10 — Basic Lighting**](10-basic-lighting/) | Blinn-Phong lighting — ambient, diffuse, and specular with world-space normals |
| [<img src="11-compute-shaders/assets/screenshot.png" width="480" alt="Compute Shaders"/>](11-compute-shaders/) | [**11 — Compute Shaders**](11-compute-shaders/) | Compute pipelines, storage textures, dispatch groups, and the compute-then-render pattern |
| [<img src="12-shader-grid/assets/screenshot.png" width="480" alt="Shader Grid"/>](12-shader-grid/) | [**12 — Shader Grid**](12-shader-grid/) | Procedural anti-aliased grid using screen-space derivatives and multiple pipelines |
| [<img src="13-instanced-rendering/assets/screenshot.png" width="480" alt="Instanced Rendering"/>](13-instanced-rendering/) | [**13 — Instanced Rendering**](13-instanced-rendering/) | Draw many copies of a mesh with per-instance vertex buffers |
| [<img src="14-environment-mapping/assets/screenshot.png" width="480" alt="Environment Mapping"/>](14-environment-mapping/) | [**14 — Environment Mapping**](14-environment-mapping/) | Cube map textures, skybox rendering, and reflective surfaces |
| [<img src="15-cascaded-shadow-maps/assets/screenshot.png" width="480" alt="Cascaded Shadow Maps"/>](15-cascaded-shadow-maps/) | [**15 — Cascaded Shadow Maps**](15-cascaded-shadow-maps/) | Shadow mapping with frustum cascade splitting and PCF soft shadows |
| [<img src="16-blending/assets/screenshot.png" width="480" alt="Blending"/>](16-blending/) | [**16 — Blending**](16-blending/) | Alpha blending, alpha testing, and additive blending with blend state configuration |
| [<img src="17-normal-maps/assets/screenshot.png" width="480" alt="Normal Maps"/>](17-normal-maps/) | [**17 — Normal Maps**](17-normal-maps/) | Tangent-space normal mapping with TBN matrix construction |
| [<img src="18-blinn-phong-materials/assets/screenshot.png" width="480" alt="Materials"/>](18-blinn-phong-materials/) | [**18 — Materials**](18-blinn-phong-materials/) | Per-material Blinn-Phong lighting with ambient, diffuse, specular, and shininess |
| [<img src="19-debug-lines/assets/screenshot.png" width="480" alt="Debug Lines"/>](19-debug-lines/) | [**19 — Debug Lines**](19-debug-lines/) | Immediate-mode debug line drawing — grids, axes, circles, and wireframe boxes |
| [<img src="20-linear-fog/assets/screenshot.png" width="480" alt="Linear Fog"/>](20-linear-fog/) | [**20 — Linear Fog**](20-linear-fog/) | Depth-based distance fog in linear, exponential, and exponential-squared modes |
| [<img src="21-hdr-tone-mapping/assets/screenshot.png" width="480" alt="HDR & Tone Mapping"/>](21-hdr-tone-mapping/) | [**21 — HDR & Tone Mapping**](21-hdr-tone-mapping/) | Render to a floating-point target, then tone map with Reinhard or ACES and exposure control |
| [<img src="22-bloom/assets/screenshot.png" width="480" alt="Bloom"/>](22-bloom/) | [**22 — Bloom**](22-bloom/) | Jimenez dual-filter bloom with 13-tap downsample, Karis averaging, and tent-filter upsample |
| [<img src="23-point-light-shadows/assets/screenshot.png" width="480" alt="Point Light Shadows"/>](23-point-light-shadows/) | [**23 — Point Light Shadows**](23-point-light-shadows/) | Omnidirectional shadow mapping with cube map depth textures and linear depth storage |
| [<img src="24-gobo-spotlight/assets/screenshot.png" width="480" alt="Gobo Spotlight"/>](24-gobo-spotlight/) | [**24 — Gobo Spotlight**](24-gobo-spotlight/) | Projected-texture spotlight with cone falloff, shadow map, and pattern projection |
| [<img src="25-shader-noise/assets/screenshot.png" width="480" alt="Shader Noise"/>](25-shader-noise/) | [**25 — Shader Noise**](25-shader-noise/) | GPU noise functions — hash, value, Perlin, fBm, and domain warping |
| [<img src="26-procedural-sky/assets/screenshot.png" width="480" alt="Procedural Sky"/>](26-procedural-sky/) | [**26 — Procedural Sky**](26-procedural-sky/) | Physically-based atmospheric scattering with Rayleigh, Mie, and LUT-accelerated transmittance |
| [<img src="27-ssao/assets/screenshot_with_ao.png" width="480" alt="SSAO"/>](27-ssao/) | [**27 — SSAO**](27-ssao/) | Screen-space ambient occlusion with G-buffer, hemisphere kernel sampling, and blur |
| [<img src="28-ui-rendering/assets/screenshot.png" width="480" alt="UI Rendering"/>](28-ui-rendering/) | [**28 — UI Rendering**](28-ui-rendering/) | Render the immediate-mode UI system on the GPU with a single draw call and font atlas |
| [<img src="29-screen-space-reflections/assets/screenshot.png" width="480" alt="Screen-Space Reflections"/>](29-screen-space-reflections/) | [**29 — Screen-Space Reflections**](29-screen-space-reflections/) | SSR with ray marching against the depth buffer and deferred shading |
| [<img src="30-planar-reflections/assets/screenshot.png" width="480" alt="Planar Reflections"/>](30-planar-reflections/) | [**30 — Planar Reflections**](30-planar-reflections/) | Mirror camera, oblique near-plane clipping, and Fresnel-blended water |
| [<img src="31-transform-animations/assets/screenshot.png" width="480" alt="Transform Animations"/>](31-transform-animations/) | [**31 — Transform Animations**](31-transform-animations/) | Keyframe animation with glTF loading, quaternion slerp, and path following |
| [<img src="32-skinning-animations/assets/screenshot.png" width="480" alt="Skinning Animations"/>](32-skinning-animations/) | [**32 — Skinning Animations**](32-skinning-animations/) | Skeletal skinning with joint hierarchies, inverse bind matrices, and per-vertex blend weights |
| [<img src="33-vertex-pulling/assets/screenshot.png" width="480" alt="Vertex Pulling"/>](33-vertex-pulling/) | [**33 — Vertex Pulling**](33-vertex-pulling/) | Programmable vertex fetch — replace fixed-function vertex input with storage buffer reads |
| [<img src="34-stencil-testing/assets/screenshot.png" width="480" alt="Stencil Testing"/>](34-stencil-testing/) | [**34 — Stencil Testing**](34-stencil-testing/) | Stencil buffer for portals, selection outlines, and per-pixel masking |
| [<img src="35-decals/assets/screenshot.png" width="480" alt="Decals"/>](35-decals/) | [**35 — Decals**](35-decals/) | Deferred decal projection onto scene geometry using depth reconstruction |
| [<img src="36-edge-detection/assets/screenshot.png" width="480" alt="Edge Detection"/>](36-edge-detection/) | [**36 — Edge Detection**](36-edge-detection/) | Sobel edge detection on G-buffer data, stencil X-ray vision, and Fresnel ghost silhouettes |
