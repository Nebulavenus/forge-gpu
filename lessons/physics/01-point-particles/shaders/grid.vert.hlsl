 ...
 *
 * Simplified single-target version for physics lessons: no view matrix,
 * no view-space normal output.  The grid quad lives on the XZ plane at
 * Y = 0, large enough to fill the visible ground.
 *
 * Vertex attributes:
