 ...
 *
 * Simplified single-target version for physics lessons: no MRT, no view-space
 * normals.  Outputs world position, world normal, and light-clip coordinates
 * for Blinn-Phong lighting with shadow mapping.
 *
 * Vertex attributes:
